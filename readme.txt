...
key differences between _EEG and _home
	Coding of triggers updated in _EEG, not updated in _home (unnecessary)
	Monitor names and settings are different
		EEG monitor = 'Sudring'
	key_pressed is different (home = left/right, EEG = num_7/num_9)
